...
//	}
    ...
    {
            if(id==null || id==0)
                    Productcategory.insert(this);
            else
                    Productcategory.update(this);
    }
    ...
    */
    ...
    public static void delete(Productcategory item)
    {
        delete(item.getId());
    }
    public static void insert(Productcategory item)
    {
        Connection conn=MySqlDBHelper.getInstance().getConnection();            
        Statement st = null;
    ...
    public static void update(Productcategory item)
    {
        Connection conn=MySqlDBHelper.getInstance().getConnection();            
        Statement st = null;
        boolean withid=false;
    ...
    public static String implodeFieldsWithValues(Productcategory item,boolean withId)
    {
            ArrayList<String> values=item.implodeFieldValuesHelper(true);//get entire list of values; whether the id is included will be dealt with later.

            if(values.size()!=fields.length)
            {
                    System.err.println("Productcategory:implodeFieldsWithValues(): ERROR: values length does not match fields length");
            }
    ...
    public static class RecordList extends ArrayList<Productcategory>{
    ...
    public static void main(String args[])
    {
        ...
        RecordList items=Productcategory.select("");
