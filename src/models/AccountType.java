...
public class AccountType {
    ...
    public AccountType(ResultSet rs) {
        try {
            id=rs.getInt("id");
...
//	}
    ...
    public void delete()
    {
            AccountType.delete(this);
    }
    public void save()
    {
            if(id==null || id==0)
                    AccountType.insert(this);
            else
                    AccountType.update(this);
    }
    ...
    */
    ...
    public static void delete(AccountType item)
    {
        delete(item.getId());
    }
    public static void insert(AccountType item)
    {
        Connection conn=MySqlDBHelper.getInstance().getConnection();            
        Statement st = null;
    ...
    public static void update(AccountType item)
    {
        Connection conn=MySqlDBHelper.getInstance().getConnection();            
        Statement st = null;
        boolean withid=false;
    ...
    public static String implodeFieldsWithValues(AccountType item,boolean withId)
    {
            ArrayList<String> values=item.implodeFieldValuesHelper(true);//get entire list of values; whether the id is included will be dealt with later.

            if(values.size()!=fields.length)
            {
                    System.err.println("AccountType:implodeFieldsWithValues(): ERROR: values length does not match fields length");
            }
    ...
    public static class RecordList extends ArrayList<AccountType>{
    ...
    public static void main(String args[])
    {
        ...
        RecordList items=AccountType.select("");
