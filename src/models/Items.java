...
public class Items {
    //------------FIELDS-----------
    public static final String tablename=Item.tablename;
    public static String[] fields=Item.fields;
    public static String[] fieldtypes=Item.fieldtypes;
    //-----------------------
    //-------------------------TABLE FUNCTIONS---------------------
    ...
    {
            HashMap<Integer,Items> map=select(" name = '"+name+"'");
            for(Items item:map)return item;
            return null;
    }	
    */
    public static Item getById(Integer id) {
            RecordList map=select(" id = '"+id.toString()+"'");
            for(Item item:map)return item;
            return null;
    }
    //-----------database functions--------------
        ...
        try { 
            ...
            while (rs.next()) {
                items.add(new Item(rs));
                    //items.put(rs.getInt("id"), new Items(rs));
            }
            return items;
        } catch (SQLException ex) {
            Logger.getLogger(Items.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static String implodeValues(Item item,boolean withId)
    {
    ...
    public static String implodeFieldsWithValues(Item item,boolean withId)
    {
            ArrayList<String> values=item.implodeFieldValuesHelper(true);//get entire list of values; whether the id is included will be dealt with later.

            if(values.size()!=fields.length)
            {
                    System.err.println("Items:implodeFieldsWithValues(): ERROR: values length does not match fields length");
            }
    ...
    public static class RecordList extends ArrayList<Item>{
