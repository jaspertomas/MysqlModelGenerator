...
//	}
    ...
    //-----------getter functions----------
    /*
    public static Products getByName(String name)
    {
            HashMap<Integer,Products> map=select(" name = '"+name+"'");
            for(Products item:map.values())return item;
            return null;
    }	
    */
    public static Products getById(Integer id) {
            HashMap<Integer,Products> map=select(" id = '"+id.toString()+"'");
            for(Products item:map.values())return item;
            return null;
    }
    //-----------database functions--------------
    ...
    public static void insert(Products item)
    {
        Connection conn=MySqlDBHelper.getInstance().getConnection();            
        Statement st = null;
    ...
    public static void update(Products item)
    {
        Connection conn=MySqlDBHelper.getInstance().getConnection();            
        Statement st = null;
        boolean withid=false;
    ...
    public static HashMap<Integer, Products> select(String conditions)
    {
        if(conditions.isEmpty())conditions = "1";
            ...
            try { 
                ...
                while (rs.next()) {
                    items.put(rs.getInt("id"), new Products(rs));
                }
                return items;
            } catch (SQLException ex) {
                Logger.getLogger(Products.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static String implodeValues(Products item,boolean withId)
    {
    ...
    public static String implodeFieldsWithValues(Products item,boolean withId)
    {
            ArrayList<String> values=item.implodeFieldValuesHelper(true);//get entire list of values; whether the id is included will be dealt with later.

            if(values.size()!=fields.length)
            {
                    System.err.println("Products:implodeFieldsWithValues(): ERROR: values length does not match fields length");
            }
    ...
    public static void main(String args[])
    {
        ...
        HashMap<Integer,Products> items=Products.select("");
        for(Integer key:items.keySet())
        {
            Products item=items.get(key);
