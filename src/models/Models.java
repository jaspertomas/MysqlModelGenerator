...
public class Models {
    ...
    public static String[] fields=Model.fields;
    public static String[] fieldtypes=Model.fieldtypes;
    //-----------------------
    //-------------------------TABLE FUNCTIONS---------------------
    ...
    {
            HashMap<Integer,Models> map=select(" name = '"+name+"'");
            for(Models item:map)return item;
            return null;
    }	
    */
    public static Model getById(Integer id) {
            RecordList map=select(" id = '"+id.toString()+"'");
            for(Model item:map)return item;
            return null;
    }
    //-----------database functions--------------
    ...
    public static void delete(Model item)
    {
        delete(item.getId());
    }
    public static Integer insert(Model item)
    {
        Connection conn=SqliteDbHelper.getInstance().getConnection();            
        Statement st = null;
    ...
    public static RecordList select(String conditions)
    {
        ...
        try { 
            ...
            while (rs.next()) {
                items.add(new Model(rs));
                    //items.put(rs.getInt("id"), new Models(rs));
            }
            return items;
        } catch (SQLException ex) {
            Logger.getLogger(Models.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static String implodeValues(Model item,boolean withId)
    {
    ...
    public static String implodeFieldsWithValues(Model item,boolean withId)
    {
            ArrayList<String> values=item.implodeFieldValuesHelper(true);//get entire list of values; whether the id is included will be dealt with later.

            if(values.size()!=fields.length)
            {
                    System.err.println("Models:implodeFieldsWithValues(): ERROR: values length does not match fields length");
            }
    ...
    public static class RecordList extends ArrayList<Model>{
