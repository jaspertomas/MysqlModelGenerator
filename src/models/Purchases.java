...
public class Purchases {
    //------------FIELDS-----------
    public static final String tablename=Purchase.tablename;
    public static String[] fields=Purchase.fields;
    public static String[] fieldtypes=Purchase.fieldtypes;
    //-----------------------
    //-------------------------TABLE FUNCTIONS---------------------
    ...
    public static Purchases getByName(String name)
    {
            ...
            for(Purchases item:map)return item;
            return null;
    }	
    */
